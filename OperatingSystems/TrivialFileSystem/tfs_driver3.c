...
int main(){
  ...
  file_is_readable("file7");
  file_is_writable("file7");
  ...
  //making files readable and writable
  file_make_readable("file5");
  file_make_writable("file5");
  file_is_readable("file5");
  file_is_writable("file5");

  file_make_readable("file6");
  file_make_writable("file6");
  file_is_readable("file6");
  file_is_writable("file5");

  file_make_readable("file7");
  file_make_writable("file7");
  file_is_readable("file7");
  file_is_writable("file7");
